...
async function delete_flight_plan(flight_plan_id) {
    ...
    {
        alert("Flight Plan with id=" + flight_plan_id + " is deleted");
    }
}
...
async function update_flight_plan() {
    let selected_flight_plan_type = 'Unknown';

    if(document.getElementById('inlineVFR').checked) {
        selected_flight_plan_type = 'VFR';
    }
    else if(document.getElementById('inlineIFR').checked) {
        selected_flight_plan_type = 'IFR';
    }
    ...
    let api_response = await fetch(api_base_url, {
        ...
        body: JSON.stringify({
            ...
            flight_type: selected_flight_plan_type,
            ...
            fuel_hours: document.getElementById('fuelHours').value,
            fuel_minutes: document.getElementById('fuelMinutes').value,
            number_onboard: document.getElementById('paxOnBoard').value
        })
    });
